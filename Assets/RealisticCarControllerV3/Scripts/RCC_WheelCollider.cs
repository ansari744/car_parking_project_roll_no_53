...
//				ApplyBrakeTorque (carController.brakeTorque * (Mathf.Clamp (carController._brakeInput, 0f, 1f) / 2f));
			if(carController._brakeInput>0.1f)
			{
				ApplyBrakeTorque ((carController.brakeTorque));

				if(carController._brakeInput>0.9f)
				{
			...
			{
				ApplyBrakeTorque ((carController.brakeTorque * 1f) * carController._brakeInput);
			}
//			ApplyBrakeTorque ((carController.brakeTorque * 1f) * carController._brakeInput);
		}
